...
This project is an interactive Power BI Dashboard built using the Supermarket Sales dataset from Kaggle.
It provides meaningful insights into sales performance, customer behavior, and overall business trends to support data-driven decision making.
